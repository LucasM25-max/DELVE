#!/usr/bin/env python3
"""Bring the audio the project needs into `pixel/assets/audio/`.
...
REPO_KEEPERS = {
    ...
    "VO_GRD_001": os.path.join("godot", "assets", "audio", "vo_grd_001.ogg"),
    "VO_GRD_002": os.path.join("godot", "assets", "audio", "vo_grd_002.ogg"),
    "VO_GRD_003": os.path.join("godot", "assets", "audio", "vo_grd_003.ogg"),
}
...
def cue_files() -> dict[str, str]:
    doc = json.load(open(os.path.join(ROOT, "data", "audio_cues.json"), encoding="utf-8"))
...
def synth_cue(cue_id: str) -> str:
    ...
    # The engine loads Ogg Vorbis and MP3; plain WAV keeps this tool dependency
    # free, and Godot imports it happily. Swap in generated art audio later.
